...
public class PrimMSTLazy {
    public static List<Edge> primMST(List<List<Edge>> adjList) {
        ...
        // Initialize the minHeap with edges connected to the first vertex (vertex 0)
        ...
        double executionTimeMinutes = (endTime - startTime) / 1e6; // 1e9 nanoseconds in a second, 60 seconds in a minute
        ...
        double spaceUsageKB = spaceUsageBytes / (1024.0 * 1024.0); // Convert bytes to kilobytes
        ...
        System.out.println("Execution Time: " + executionTimeMinutes + " milliseconds");
